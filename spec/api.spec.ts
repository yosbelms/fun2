import { createApiClient, serializeApi, callInApi, SERIALIZED_FUNCTION_TOKEN } from '../api'
import 'jasmine'
...
describe('api', () => {
  ...
  describe('callInApi', () => {
    ...
    it('should call with middleware', () => {
      const ctx = 1
      const middleware = (ctx: any, next: Function) => ctx + next()
      const result = callInApi(api, [], 'func', [1], ctx, middleware)
